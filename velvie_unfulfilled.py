...
# --- CONFIGURATION ---
SHOPIFY_ACCESS_TOKEN = os.getenv("SHOPIFY_ACCESS_TOKEN_VELVIE")
SHOP_NAME = "luxmery-usa-shop"
API_VERSION = "2024-07"
...
for loc in locations:
    ...
    if all_orders:
        ...
        message = f"🚨 * VELVIE Unfulfilled orders* (from {created_at_min[:10]} to {created_at_max[:10]}) for *{location_name}*:\n{order_list}"
    else:
        message = f"✅ No VELVIE unfulfilled orders between {created_at_min[:10]} and {created_at_max[:10]} for *{location_name}*."
